...
def run_script(script_path, script_owner_id, user_folder, file_name, message_obj, attempt=1):
    ...
    try:
        ...
        terminal_msg = f"""
╔══════════════════════════════════════╗
║      🚀 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: STARTING SCRIPT</b> 🚀 ║
╠══════════════════════════════════════╣
...
"""
        ...
        if process.poll() is None:
            success_msg = f"""
╔══════════════════════════════════════╗
║     ✅ <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: SCRIPT RUNNING</b> ✅   ║
╠══════════════════════════════════════╣
...
"""
            ...
            error_msg = f"""
╔══════════════════════════════════════╗
║     ❌ <b> 𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: SCRIPT FAILED</b> ❌     ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
...
def run_js_script(script_path, script_owner_id, user_folder, file_name, message_obj, attempt=1):
    ...
    try:
        ...
        terminal_msg = f"""
╔══════════════════════════════════════╗
║      🟢 <b>  𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: STARTING NODE.JS</b> 🟢║
╠══════════════════════════════════════╣
║ 📄 File: <code>{file_name[:25]}</code>
║ 👤 User: {script_owner_id}
║ 🔄 Attempt: {attempt}/{max_attempts}
...
"""
        ...
        if process.poll() is None:
            success_msg = f"""
╔══════════════════════════════════════╗
║     ✅ <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: NODE.JS RUNNING</b> ✅  ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
║ 🆔 <b>PID:</b> {process.pid}
║ ⏱️ <b>Started:</b> {datetime.now().strftime('%H:%M:%S')}
...
"""
            ...
            error_msg = f"""
╔══════════════════════════════════════╗
║     ❌ <b>  𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: NODE.JS FAILED</b> ❌    ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
║ ❗ <b>Exit Code:</b> {process.returncode}
╠══════════════════════════════════════╣
...
def stats_command(message):
    ...
    user_id = message.from_user.id
    msg = send_spinner_animation(message.chat.id, "𝐆𝐚𝐭𝐡𝐞𝐫𝐢𝐧𝐠 𝐔𝐗 40 𝐬𝐭𝐚𝐭𝐬...", duration=2)
...
def speed_command(message):
    ...
    msg = send_spinner_animation(message.chat.id, "𝐓𝐞𝐬𝐭𝐢𝐧𝐠 ㅤ  𝐔𝐗 40 𝐬𝐩𝐞𝐞𝐝...", duration=2)
...
def process_broadcast(message):
    ...
    for i, user_id in enumerate(active_users):
        try:
            formatted_msg = f"""
╔══════════════════════════════════════╗
║      📢 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒 🦁 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓</b> 📢    ║
╠══════════════════════════════════════╣
║
{broadcast_text}
║
...
"""
    ...
    result_text = f"""
╔══════════════════════════════════════╗
║     ✅ <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 𝐂𝐎𝐌𝐏𝐋𝐄𝐓𝐄</b> ✅ ║
╠══════════════════════════════════════╣
║
║  📤 𝐓𝐨𝐭𝐚𝐥: {total}
║  ✅ 𝐒𝐮𝐜𝐜𝐞𝐬𝐬: {success}
...
def subscribe_command(message):
    ...
    sub_text = f"""
╔══════════════════════════════════════╗
║      ✅ <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐔𝐁𝐒𝐂𝐑𝐈𝐏𝐓𝐈𝐎𝐍</b> ✅   ║
╠══════════════════════════════════════╣
║
║  👤 𝐔𝐬𝐞𝐫: {target_user}
║  📅 𝐃𝐚𝐲𝐬: {days}
...
def handle_text(message):
    ...
    if text == "📢 Updates Channel":
        bot.send_message(message.chat.id, f"📢 𝐉𝐨𝐢𝐧 𝐨𝐮𝐫 𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐮𝐩𝐝𝐚𝐭𝐞𝐬:\n{UPDATE_CHANNEL}")
...
def handle_upload_request(message):
    ...
    upload_text = f"""
╔══════════════════════════════════════╗
║       📤 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: FILE UPLOAD</b> 📤   ║
╠══════════════════════════════════════╣
║
║  𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 𝐟𝐢𝐥𝐞 𝐧𝐨𝐰!
║
...
def show_user_files(message):
    ...
    user_id = message.from_user.id
    msg = send_spinner_animation(message.chat.id, "𝐋𝐨𝐚𝐝𝐢𝐧𝐠 ㅤ 𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒 𝐟𝐢𝐥𝐞𝐬...", duration=1)
    files = user_files.get(user_id, [])
    if not files:
        text = """
╔══════════════════════════════════════╗
║       📂 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: YOUR FILES</b> 📂   ║
╠══════════════════════════════════════╣
║
...
def show_subscriptions(message):
    ...
    text = f"""
╔══════════════════════════════════════╗
║     💳 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: SUBSCRIPTIONS</b> 💳    ║
╠══════════════════════════════════════╣
║
...
def show_admin_panel(message):
    ...
    admin_text = f"""
╔══════════════════════════════════════╗
║       👑 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: ADMIN PANEL</b> 👑   ║
╠══════════════════════════════════════╣
║
║  <b>📊 𝐒𝐭𝐚𝐭𝐢𝐬𝐭𝐢𝐜𝐬:</b>
...
def handle_document(message):
    ...
    upload_text = f"""
╔══════════════════════════════════════╗
║      📤 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: UPLOADING</b> 📤     ║
╠══════════════════════════════════════╣
║
...
def stop_user_script(call, file_name):
    ...
    stop_text = f"""
╔══════════════════════════════════════╗
║       🛑 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: STOPPING</b> 🛑     ║
╠══════════════════════════════════════╣
║
...
def delete_user_file(call, file_name):
    ...
    confirm_text = f"""
╔══════════════════════════════════════╗
║      ⚠️ <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: DELETE?</b> ⚠️      ║
╠══════════════════════════════════════╣
║
║  𝐀𝐫𝐞 𝐲𝐨𝐮 𝐬𝐮𝐫𝐞?
║  📄 <code>{file_name[:25]}</code>
...
def confirm_delete_file(call, file_name):
    ...
    delete_text = f"""
╔══════════════════════════════════════╗
║       🗑️ <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: DELETING</b> 🗑️     ║
╠══════════════════════════════════════╣
║
║  📄 <code>{file_name[:25]}</code>
║  ⏳ 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭...
...
def show_admin_logs(call):
    ...
    try:
        ...
        conn.close()
        if logs:
            text = "📋 <b>𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒: RECENT LOGS</b>\n"
            for log in logs:
                text += f"👤 {log[0]} | {log[1]}\n{log[2][:30]}...\n🕐 {log[3][:16]}\n"
        else:
            text = "📋 𝐍𝐨 𝐥𝐨𝐠𝐬."
...
def cleanup_on_exit():
    ...
    logger.info("𝐂𝐥𝐞𝐚𝐧𝐢𝐧𝐠 𝐮𝐩 𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒...")
    for script_key in list(bot_scripts.keys()):
        try:
            script_info = bot_scripts[script_key]
            kill_process_tree(script_info)
...
def main():
    ...
    logger.info("=" * 50)
    logger.info("🤖 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠 𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒 🦁 𝐁𝐨𝐭...")
    ...
    while True:
        try:
            ...
            logger.error(f"𝐔𝐗 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐓𝐀𝐓𝐔𝐒 𝐞𝐫𝐫𝐨𝐫: {e}", exc_info=True)
            time.sleep(5)
